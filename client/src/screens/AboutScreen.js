    ...
    <>
      <Jumbotron>
        <div className="about-text">
          <h1 className="text-center mb-4">Alpine Survival School Courses</h1>
          <p>
            ...
            around the United States. Alpine Survival School offers a set of
        ...
        <p className="text-center mt-4">
          <LinkContainer to="/">
            <Button variant="primary">Choose a Course</Button>
          </LinkContainer>
        </p>
      </Jumbotron>
    </>
